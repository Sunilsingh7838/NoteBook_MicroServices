...
import in.mvc.binding.CustomerEvent;
...
public class CustomerRestController {
	...
	public ResponseEntity<Mono<CustomerEvent>> getEvent(){
		CustomerEvent event = new CustomerEvent("Sunil", new Date());
	...
	public ResponseEntity<Flux<CustomerEvent>> getEvents(){
		...
		//create binding object with data
		CustomerEvent event = new CustomerEvent("Sunil", new Date());
		...
		//Getting tuple(column) value as T2
